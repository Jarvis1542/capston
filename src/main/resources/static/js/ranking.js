    ...
    $.ajax({
        ...
        for (var i = 0; i < msg.length; i++){
            $(".none_aaa").append("<div class=\"single_carousel\">\n" +
                ...
                "                    <div class=\"single_testmonial d-flex align-items-center\">\n" +
                "                        <div class=\"thumb\">\n" +
                "                            <img src="+msg[i].hp_PIC+" alt=\"\" style=\"width:240px; height:200px; \">\n" +
                "                                <div class=\"quote_icon\">\n" +
                "                                    <i class=\"Flaticon flaticon-quote\"></i>\n" +
                "                                </div>\n" +
                "                        </div>\n" +
        ...
        console.log("rank_arr2",rank_arr2);
        console.log("rank_arr2", rank_arr2[0].hp_PIC);
        console.log("JIIIII", rank_arr2[0].jibun_addr);
    }).fail(function (error) {
        console.log("에러 : ", error);
    });
});